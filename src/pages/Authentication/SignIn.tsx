...
import { login } from '../../api/fetching/auth/authActions';
    ...
    <div className="rounded-sm border border-stroke h-screen bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-29 text-center">
            <Link className="mb-5.5 inline-block" to="/">
              <img className="hidden dark:block" src={Logo} alt="Logo" />
              <img className="dark:hidden" src={LogoDark} alt="Logo" />
            </Link>

            <p className="2xl:px-16 w-full">
              Bima Nusa Internasional memiliki layanan yang luar biasa,
              menyediakan layanan yang andal dan efisien. Kami memiliki tim ahli
              yang siap membantu dalam mengelola aset pertambangan secara
              efektif dan menghasilkan keuntungan yang optimal.
            </p>
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <div className="mt-6 text-center">
              <p>
                Forgot password ?{' '}
                <Link to="/send-email" className="text-primary">
                  click here
                </Link>
              </p>
            </div>
