...
import { resetPassword } from '../../api/fetching/auth/authActions';
        ...
        <div className="flex flex-wrap items-center ">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-16 w-full">
                Di balik setiap akses yang aman, ada kata sandi yang kuat.
                Sebuah kata sandi bukan hanya urutan karakter acak; itu adalah
                kunci yang mengunci rahasia Anda dari pandangan yang tidak
                diinginkan. Ingatlah, kekuatan sebuah kata sandi terletak pada
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <p className="mb-9 text-black dark:text-white">
